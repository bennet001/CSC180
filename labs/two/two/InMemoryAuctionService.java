package labs.two.two;

import java.util.ArrayList;
import java.util.Collection;
import java.util.Stack;

import labs.two.one.AndPredicate;
import labs.two.one.ContainsPredicate;
import labs.two.one.OrPredicate;
import labs.two.one.Predicate;
...
public class InMemoryAuctionService implements AuctionService {
	...
	public Auction[] Filter(Collection<Auction> providedCollection, Predicate<Auction> providedPredicate) {
		...
		return searchResult.toArray(container);
	}
